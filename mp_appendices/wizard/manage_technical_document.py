...
class ManageDocumentWizard(models.TransientModel):
    ...
    partner_ids = fields.Many2many('res.partner', 'document_partner_wizard_rel', 'wizard_id', 'partner_id', string='Partners', default=_default_partner_ids)
    ...
    def button_save(self):
        ...
        if self.partner_ids:
            ...
            return {'warning': _('Partner field should be set before applying changes')}
